<template>
	<div fill-height class="h-100">
		...
		<v-stepper-header class="elevation-0">
				...
				<v-stepper-step step="1" :complete="e1 > 1">Ubicación</v-stepper-step>
				<v-divider></v-divider>
				<v-stepper-step step="2" :complete="e1 > 2">Título y Descripción</v-stepper-step>
				<v-divider></v-divider>
				<v-stepper-step step="3" :complete="e1 > 3">Especificaciones</v-stepper-step>
				<v-divider></v-divider>
				<v-stepper-step step="4" :complete="e1 > 4">Servicios</v-stepper-step>
				<v-divider></v-divider>
